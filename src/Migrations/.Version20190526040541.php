 ...
 */
final class Version20190526040541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE basket (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id_id INTEGER NOT NULL)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2246507B9D86650F ON basket (user_id_id)');
        $this->addSql('CREATE TABLE basket_product (basket_id INTEGER NOT NULL, product_id INTEGER NOT NULL, PRIMARY KEY(basket_id))');
